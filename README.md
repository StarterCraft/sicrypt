...
## Contents
1. [Что такое Sicrypt?](#Описание)
2. [Создан с использованием...](#Использованы)
3. [Журнал изменений по версиям](https://github.com/StarterCraft/sicrypt/blob/master/changelog.txt)
4. [Установка](#Установка)
5. [Описание функций](#Использование) 
    1. [Шифровка](#Шифровка)
    2. [Дешифровка](#Дешифровка)
    3. [Открытие файла](#Открытие)
    4. [Сохранение в файл](#Сохранение)
    5. [Копирование в буфер обмена и вставка из него](#Буфер)
    6. [Перенос текста из одного поля в другое](#Перенос)
    7. [Настройка программы](#Настройки)
6. [Шифры](#Шифры)
    1. [Скачивание](#Скачивание)
    2. [Создание вашего собственного шифра](#Создание)
